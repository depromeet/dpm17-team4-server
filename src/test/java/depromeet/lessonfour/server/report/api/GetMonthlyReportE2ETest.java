...
//    validJwtToken = "Bearer " +
// jwtTokenGenerator.generateAccessToken(AccountContext.of(testUser));
//
...
//    createToilet(start.plusDays(12).atTime(6, 0), ToiletColor.GOLD, ToiletShape.ROCK, 25, 8,
// null);
//
//    given()
...
//
//    // 이번 달 일부만 데이터
//    createActivity(start.plusDays(1).atTime(9, 0), "사과", MealTime.BREAKFAST, 4,
// StressLevel.MEDIUM);
//
//    given()
//        .header("Authorization", validJwtToken)
...
//    createToilet(
//        thisMonthDay.plusDays(2).atTime(9, 0), ToiletColor.DEFAULT, ToiletShape.CREAM, 55, 7,
// null);
//
//    given()
//        .header("Authorization", validJwtToken)
