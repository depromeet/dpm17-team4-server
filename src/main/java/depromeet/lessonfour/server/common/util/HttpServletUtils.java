...
import static depromeet.lessonfour.server.auth.infra.security.jwt.JwtConstants.AUTHORIZATION_HEADER;
import static depromeet.lessonfour.server.auth.infra.security.jwt.JwtConstants.BEARER_PREFIX;
