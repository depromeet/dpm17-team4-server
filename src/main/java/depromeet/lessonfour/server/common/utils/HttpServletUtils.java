...
import static depromeet.lessonfour.server.common.auth.security.jwt.JwtConstants.AUTHORIZATION_HEADER;
import static depromeet.lessonfour.server.common.auth.security.jwt.JwtConstants.BEARER_PREFIX;
