...
public record ToiletRecordCreateRequestDto(
    ...
    @ValidEnum(enumClass = ToiletColor.class, message = "유효하지 않은 배변 색깔입니다.") ToiletColor color,
    @ValidEnum(enumClass = ToiletShape.class, message = "유효하지 않은 배변 형태입니다.") ToiletShape shape,
